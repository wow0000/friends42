...
map = {
	"c1": [
		...
		['c1r4s1', '', 'c1r4s2', '', 'c1r4s3', '', 'c1r4s4', '', 'c1r4s5', '', 'c1r4s6', '', 'c1r4s7', '', 'c1r4s8', '', 'c1r4s9', ''],
	],
	"c2": [
		['R1', 'R2', 'R3', 'R4'],
		['c2r1s1', '', 'c2r1s2', '', 'c2r1s3', '', 'c2r1s4', '', 'c2r1s5', '', 'c2r1s6', '', 'c2r1s7', '', 'c2r1s8', '', 'c2r1s9', ''],
		...
		['c2r4s1', '', 'c2r4s2', '', 'c2r4s3', '', 'c2r4s4', '', 'c2r4s5', '', 'c2r4s6', '', 'c2r4s7', '', 'c2r4s8', '', 'c2r4s9', ''],
	],
	"c3": [
		['R1', 'R2', 'R3', 'R4'],
		['c3r1s1', '', 'c3r1s2', '', 'c3r1s3', '', 'c3r1s4', '', 'c3r1s5', '', 'c3r1s6', '', 'c3r1s7', '', 'c3r1s8', '', 'c3r1s9', ''],
		...
		['c3r4s1', '', 'c3r4s2', '', 'c3r4s3', '', 'c3r4s4', '', 'c3r4s5', '', 'c3r4s6', '', 'c3r4s7', '', 'c3r4s8', '', 'c3r4s9', ''],
	],
	"c4": [
		['R1', 'R2', 'R3', 'R4'],
		['c4r1s1', '', 'c4r1s2', '', 'c4r1s3', '', 'c4r1s4', '', 'c4r1s5', '', 'c4r1s6', '', 'c4r1s7', '', 'c4r1s8', '', 'c4r1s9', ''],
